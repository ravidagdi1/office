...
const mivFormSchema = new mongoose.Schema({
  mivNo: {
    type: Number,
    unique: true,
    required: [true, 'A request must have a miv no']
  },
  image: {
    type: String,
...
mivFormSchema.pre(/^find/, function (next) {
...
const Miv = mongoose.model('Miv', mivFormSchema);
